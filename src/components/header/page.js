    ...
    <div className="relative h-96 overflow-hidden">
      ...
      <div className="absolute inset-0 flex justify-center items-center text-amber-400 flex-col space-y-4 ">
        ...
        <p className="text-slate-300 w-1/2">
          Explore a world of exciting events with EventMakers. From music
          concerts to art festivals, we provide exclusive access to
          unforgettable experiences. Find, join, and create lasting memories
          with us.
        </p>
      </div>
    </div>
